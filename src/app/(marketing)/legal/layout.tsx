      ...
      <div className="shell max-w-3xl">
        <div
          className="[&_h2]:mt-10 [&_h2]:font-[family-name:var(--font-display)] [&_h2]:text-xl [&_h2]:font-semibold
            [&_p]:mt-4 [&_p]:text-[15px] [&_p]:leading-relaxed [&_p]:text-[var(--color-on-surface-variant)]
            [&_ul]:mt-4 [&_ul]:space-y-2 [&_ul]:pl-5
            [&_li]:list-disc [&_li]:text-[15px] [&_li]:leading-relaxed [&_li]:text-[var(--color-on-surface-variant)]
